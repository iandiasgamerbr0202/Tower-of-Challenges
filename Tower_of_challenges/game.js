...
}; //This functions is to randomize the Threat of the player against the target;
...
}; // This object is going to help me calculate precisely the damage that the player deals
let this_turn_player_was_attacked = {
  which_attack: null, //object.variable.string
  damage_received: null, //number           //this variable is to help me to calculate precisely the damage that the player receives
...
let player_moves = {
  ...
  interact: {
    check: {
      check_status: player_target_stats, /* Beta; */
